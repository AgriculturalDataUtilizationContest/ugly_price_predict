...
from app.util.mymodule.PatchTST_layers import *
from app.util.mymodule.RevIN import RevIN
        ...
        **kwargs,
        ...
        if self.revin:
            self.revin_layer = RevIN(
                in_features, affine=affine, subtract_last=subtract_last
            )
        ...
        if self.pretrain_head:
            self.head = self.create_pretrain_head(
                self.head_nf, in_features, fc_dropout
